# Generated by Powerlevel10k configuration wizard on 2020-05-16 at 17:00 CEST.
...
() {
  ...
  # Red prompt symbol if the last command succeeded.
  ...
  # Blue host name.
  typeset -g POWERLEVEL9K_HOST_FOREGROUND='blue'
